...
int angle1;
int angle2;
const int angleMin1  = 1300;//  Modifie le 26/12/2023
const int angleMax1 = 2000;
const int angleMin2  = 1300;//  Modifie le 26/12/2023
const int angleMax2 = 2000;
const int ANGLE1SOUSTENSION = 2000;//  Modifie le 26/12/2023
const int ANGLE2SOUSTENSION = 2000;//  Modifie le 26/12/2023
...
int retardFermetureBarrieres = 800;//  Temps avant fermeture en ms
int retardOuvertureBarrieres = 800;//  Temps avant ouverture en ms
